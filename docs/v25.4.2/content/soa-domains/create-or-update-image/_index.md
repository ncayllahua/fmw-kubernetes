...
The installation binaries and patches required for release 25.4.2 are:
...
* Fusion Middleware Infrastructure patches:
    ...
    * p28186730_1394221_Generic.zip (OPATCH 13.9.4.2.20 FOR EM 13.5 AND FMW/WLS 12.2.1.4.0, 14.1.1.0.0, 14.1.2.0.0)
    * p38073767_122140_Generic.zip (OWSM BUNDLE PATCH 12.2.1.4.250613)
    * p38348152_122140_Generic.zip (ADF BUNDLE PATCH 12.2.1.4.250822)
    * p38412437_122140_Generic.zip (WLS PATCH SET UPDATE 12.2.1.4.250910)
    ...
    * p38409281_122140_Generic.zip (Coherence 12.2.1.4 Cumulative Patch 27 (12.2.1.4.27))
    ...
    * p38400138_122140_Generic.zip (WebCenter Core Bundle Patch 12.2.1.4.250904)
    ...
    * p38199225_122140_Generic.zip (RDA release 25.4-20251021 for FMW 12.2.1.4.0)
    * p37925688_122140_Generic.zip (JDBC19.27 BUNDLE PATCH 12.2.1.4.250514)
    * p38405729_122140_Generic.zip (FMW Thirdparty Bundle Patch 12.2.1.4.250909)
    * p38379810_122140_Generic.zip (OSS 19C BUNDLE PATCH 12.2.1.4.250902)
    * p34065178_122140_Generic.zip (OVD One Off)

* Oracle SOA Suite and Oracle Service Bus patches

    * p38253323_122140_Generic.zip (SOA Bundle Patch 12.2.1.4.250729)
    * p38059281_122140_Generic.zip (OSB BUNDLE PATCH 12.2.1.4.250611)
...
1. Add a JDK package to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addInstaller --type jdk --version 8u471 --path <download location>/jdk-8u471-linux-x64.tar.gz
    ```
...
1. Add the downloaded OPatch patch to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addEntry --key 28186730_13.9.4.2.21 --value <download location>/p28186730_1394221_Generic.zip
    ```

1. Append the `--opatchBugNumber` flag and the OPatch patch key to the `create` command in the `buildArgs` file:

    ``` bash
    --opatchBugNumber 28186730_13.9.4.2.21
    ```

1. Add the downloaded product patches to the WebLogic Image Tool cache:  

    ``` bash   
        $ imagetool cache addEntry --key 38073767_12.2.1.4.0 --value <download location>/38073767_122140_Generic.zip
		
        $ imagetool cache addEntry --key 38348152_12.2.1.4.0 --value <download location>/38348152_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38412437_12.2.1.4.0 --value <download location>/38412437_122140_Generic.zip
        
	$ imagetool cache addEntry --key 34809489_12.2.1.4.0 --value <download location>/34809489_122140_Generic.zip
        
	$ imagetool cache addEntry --key 36789759_12.2.1.4.0 --value <download location>/36789759_122140_Generic.zip
        
	$ imagetool cache addEntry --key 36316422_12.2.1.4.0 --value <download location>/36316422_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38409281_12.2.1.4.0 --value <download location>/38409281_122140_Generic.zip
        
	$ imagetool cache addEntry --key 37056593_12.2.1.4.0 --value <download location>/37056593_122140_Generic.zip
        
	$ imagetool cache addEntry --key 36426672_12.2.1.4.0 --value <download location>/36426672_122140_Generic.zip
        
	$ imagetool cache addEntry --key 33093748_12.2.1.4.0 --value <download location>/33093748_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38400138_12.2.1.4.0 --value <download location>/38400138_122140_Generic.zip
        
	$ imagetool cache addEntry --key 36946553_12.2.1.4.0 --value <download location>/36946553_122140_Generic.zip
        
	$ imagetool cache addEntry --key 34765492_12.2.1.4.0 --value <download location>/34765492_122140_Generic.zip
        
	$ imagetool cache addEntry --key 34542329_12.2.1.4.0 --value <download location>/34542329_122140_Generic.zip
        
	$ imagetool cache addEntry --key 35965629_12.2.1.4.0 --value <download location>/35965629_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38199225_12.2.1.4.0 --value <download location>/38199225_122140_Generic.zip
        
	$ imagetool cache addEntry --key 37925688_12.2.1.4.0 --value <download location>/37925688_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38405729_12.2.1.4.0 --value <download location>/38405729_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38379810_12.2.1.4.0 --value <download location>/38379810_122140_Generic.zip
        
	$ imagetool cache addEntry --key 34065178_12.2.1.4.0 --value <download location>/34065178_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38253323_12.2.1.4.0 --value <download location>/38253323_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38059281_12.2.1.4.0 --value <download location>/38059281_122140_Generic.zip
        
	$ imagetool cache addEntry --key 33404495_12.2.1.4.0 --value <download location>/33404495_122140_Generic.zip
        
	$ imagetool cache addEntry --key 32827327_12.2.1.4.0 --value <download location>/32827327_122140_Generic.zip
        
	$ imagetool cache addEntry --key 31713053_12.2.1.4.0 --value <download location>/31713053_122140_Generic.zip
...
1. Append the `--patches` flag and the product patch keys to the `create` command in the `buildArgs` file. The `--patches` list must be a comma-separated collection of patch `--key` values used in the `imagetool cache addEntry` commands above.
   ...
   Sample `--patches` list for the product patches added in to the cache:
      ...
      ```
      --patches 38073767_12.2.1.4.0,38348152_12.2.1.4.0,38412437_12.2.1.4.0,34809489_12.2.1.4.0,36789759_12.2.1.4.0,36316422_12.2.1.4.0,38409281_12.2.1.4.0,37056593_12.2.1.4.0,36426672_12.2.1.4.0,33093748_12.2.1.4.0,38400138_12.2.1.4.0,36946553_12.2.1.4.0,34765492_12.2.1.4.0,34542329_12.2.1.4.0,35965629_12.2.1.4.0,38199225_12.2.1.4.0,37925688_12.2.1.4.0,38405729_12.2.1.4.0,38379810_12.2.1.4.0,34065178_12.2.1.4.0,38253323_12.2.1.4.0,38059281_12.2.1.4.0,33404495_12.2.1.4.0,32827327_12.2.1.4.0,31713053_12.2.1.4.0      
      ```
    ...
    > * `--pull` always pulls the latest base Linux image `oraclelinux:8-slim` from the Docker registry. This flag can be removed if you want to use the Linux image `oraclelinux:8-slim`, which is already available on the host where the SOA image is created.
...
1. Create the Oracle SOA Suite image:
    ...
    COPY --chown=oracle:root jdk-8u471-linux-x64.tar.gz /tmp/imagetool/

    USER oracle


    RUN tar xzf /tmp/imagetool/jdk-8u471-linux-x64.tar.gz -C /u01 \
    ...
    # Update OPatch and apply WebLogic patches
        COPY --chown=oracle:root p28186730_1394221_Generic.zip /tmp/imagetool/opatch/
        RUN cd /tmp/imagetool/opatch \
        && /u01/jdk/bin/jar -xf /tmp/imagetool/opatch/p28186730_1394221_Generic.zip \
...
1. Provide the following arguments to the WebLogic Image Tool `update` command:
    ...
    * `--tag` - Specify the new tag to be applied for the image being built.
    ...
    $ imagetool update --fromImage soasuite:12.2.1.4 --chown oracle:root --tag=soasuite:12.2.1.4-30761841 --patches=30761841_12.2.1.4.0 --opatchBugNumber=28186730_13.9.4.2.21
      ...
      [INFO   ] Using patch 28186730_13.9.4.2.21 from cache: <downloaded-patches-location>/p28186730_1394221_Generic.zip
      ...
      Oracle Interim Patch Installer version 13.9.4.2.21
      ...
      OPatch version    : 13.9.4.2.21
      OUI version       : 13.9.4.2.21
    ...
    $ imagetool update --fromImage soasuite:12.2.1.4 --chown oracle:root --tag=soasuite:12.2.1.4-30761841 --patches=30761841_12.2.1.4.0 --opatchBugNumber=28186730_13.9.4.2.21 --dryRun
