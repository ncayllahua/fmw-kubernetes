...
> Note: See [here](https://github.com/oracle/fmw-kubernetes/blob/v25.4.2/OracleSOASuite/kubernetes/charts/ingress-per-domain/README.md#configuration) for all the configuration parameters.
