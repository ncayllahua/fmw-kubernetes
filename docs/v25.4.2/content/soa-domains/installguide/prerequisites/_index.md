...
Release 25.4.2 has the following system requirements:

* Kubernetes 1.26.2+, 1.27.2+, 1.28.2+, 1.29.1+, 1.30.1+, 1.31.1+ and 1.32.1+ (check with `kubectl version`).
...
* WebLogic Kubernetes Operator 4.2.19 (see the [operator releases 4.2.19](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.2.19) pages).
