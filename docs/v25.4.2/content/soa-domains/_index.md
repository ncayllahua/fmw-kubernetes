...
The current production release for the Oracle SOA Suite domains deployment on Kubernetes is [25.4.2](https://github.com/oracle/fmw-kubernetes/releases). This release uses the WebLogic Kubernetes Operator version [4.2.19](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.2.19).
...
* [Version 25.3.2](https://oracle.github.io/fmw-kubernetes/25.3.2/soa-domains/)
