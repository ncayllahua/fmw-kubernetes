...
The current production release for the Oracle HTTP Server 12.2.1.4 deployment on Kubernetes is [25.4.1](https://github.com/oracle/fmw-kubernetes/releases).
...
* [Version 25.3.1](https://oracle.github.io/fmw-kubernetes/25.3.1/ohs/)
